...
We will look at the S&P 600 Small Cap Index top performance stock names and compare it to the performance of Technology Index XLK.
...
library(tidyverse)
library(tidyquant)
library(rvest)  # Add rvest library
